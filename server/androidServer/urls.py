...
from .views import save_user_credentials, update_lat_long, post_sos_request, delete_sos_request, get_volunteers_list
...
urlpatterns = [
    ...
    url(r'VolunteerList/$', get_volunteers_list)
]
